...
| `cham-tay.py` | Công cụ **đo độ chính xác** của bộ lọc `is_q` bằng cách gắn nhãn tay 30 mẫu. Không nằm trong yêu cầu của BTC — để dùng khi cần siết số. Phiếu chấm không commit *(chứa nguyên văn tin nhắn)* | tuỳ chọn |
